...
public class EmployerService : IEmployerService
{
        ...
        Guid userId, FileUploadRequest file, CancellationToken cancellationToken = default)
    {
        ...
        var company = employer.Company;
        // company cannot be null if CompanyId is correctly set and loaded, but adding defensive check is ok if it was nullable
        // Since Employer.Company is non-nullable in entity, we don't strictly need it, but we can check CompanyId
        if (employer.CompanyId == Guid.Empty)
